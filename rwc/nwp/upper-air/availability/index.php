...
<div class="control">
<label class="label"><i class="fas fa-globe-centre"></i>Monitoring Centre</label>
<select class="select" id="monitoringSelect">
<option value="All_Centre" selected>All Centre</option>
<optgroup label="All">
