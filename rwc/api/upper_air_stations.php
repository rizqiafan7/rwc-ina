...
try {
    ...
    if ($is_usa_territory) {
        $usa_api_url = "https://wdqms.wmo.int/wdqmsapi/v1/download/gbon/temp/$period/availability/?" . 
                       "date=$date&variable=$variable&centers=DWD,ECMWF,JMA,NCEP&countries=USA&region=pacific";
    ...
    $url = "https://wdqms.wmo.int/wdqmsapi/v1/download/gbon/temp/$period/availability/?" . 
           "date=$date&variable=$variable&centers=DWD,ECMWF,JMA,NCEP&countries=$territory";
